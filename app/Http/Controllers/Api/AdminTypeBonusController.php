...
class AdminTypeBonusController extends BaseController
{
    const POST_TYPE = 'type-bonus';
    const MAIN_TABLE = 'type_bonuses';
    const META_TABLE = 'type_bonus_meta';
    const CATEGORY_TABLE = 'type_bonus_category';
    const CATEGORY_RELATIVE = 'type_bonus_category_relative';
