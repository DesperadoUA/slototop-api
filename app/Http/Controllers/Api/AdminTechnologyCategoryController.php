...
class AdminTechnologyCategoryController extends BaseController
{
    const POST_TYPE = 'technology';
    const MAIN_TABLE = 'licenses';
    const META_TABLE = 'technology_meta';
    const CATEGORY_TABLE = 'technology_category';
    const RELATIVE_TABLE = 'technology_category_relative';
