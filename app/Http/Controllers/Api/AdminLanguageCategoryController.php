...
class AdminLanguageCategoryController extends BaseController
{
    const POST_TYPE = 'lang';
    const MAIN_TABLE = 'languages';
    const META_TABLE = 'language_meta';
    const CATEGORY_TABLE = 'language_category';
    const RELATIVE_TABLE = 'language_category_relative';
