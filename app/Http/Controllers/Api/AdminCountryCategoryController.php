...
class AdminCountryCategoryController extends BaseController
{
    const POST_TYPE = 'country';
    const MAIN_TABLE = 'countries';
    const META_TABLE = 'country_meta';
    const CATEGORY_TABLE = 'country_category';
    const RELATIVE_TABLE = 'country_category_relative';
